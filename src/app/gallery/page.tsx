...
const GRADES: { grade: Grade; label: string; color: string; textColor: string }[] = [
  { grade: "א", label: "כיתה א׳", color: "from-rose-200/80 to-rose-300/80", textColor: "text-rose-800" },
  { grade: "ב", label: "כיתה ב׳", color: "from-orange-200/80 to-amber-300/80", textColor: "text-orange-800" },
  { grade: "ג", label: "כיתה ג׳", color: "from-amber-200/80 to-yellow-300/80", textColor: "text-amber-800" },
  { grade: "ד", label: "כיתה ד׳", color: "from-emerald-200/80 to-teal-300/80", textColor: "text-emerald-800" },
  { grade: "ה", label: "כיתה ה׳", color: "from-sky-200/80 to-cyan-300/80", textColor: "text-sky-800" },
  { grade: "ו", label: "כיתה ו׳", color: "from-violet-200/80 to-purple-300/80", textColor: "text-violet-800" },
];
    ...
    <div className="h-screen flex flex-col relative overflow-hidden">
      ...
      <main className="relative z-10 flex-1 p-2 md:p-4 min-h-0 flex items-center justify-center">
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 md:gap-4 place-items-center">
          {GRADES.map(({ grade, label, color, textColor }) => (
            <Link
              key={grade}
              href={`/gallery/${grade}`}
              className={`
