      ...
      <div className="max-w-lg mx-auto">
        <Card className="text-center py-8 animate-scale-in">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Button variant="outline" onClick={handleBackToJournal} rightIcon={ArrowRight}>
              חזרה לדף הראשי
            </Button>
          </div>
        </Card>
    ...
    <div className="max-w-5xl space-y-6 mx-auto">
      ...
      <Card>
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-rubik font-bold text-foreground">
              רפלקציה אישית - {questionnaire.name}
            </h1>
