...
const navItems: NavItem[] = [
  ...
  { label: "משחקים", href: "/games", roles: ["student"], icon: Puzzle },
  { label: "ניהול משחקים", href: "/games", roles: ["admin"], icon: Puzzle },
  ...
  { label: "STEM במשפחה", href: "/stem-family", roles: ["parent"], icon: Trophy },
